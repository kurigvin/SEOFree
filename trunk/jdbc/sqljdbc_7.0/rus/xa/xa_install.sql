...
-- distributed transaction and XA support for the Microsoft JDBC Driver 7.0 for SQL Server.
...
-- #2. Permissions to the distributed transaction support procedures for the Microsoft JDBC Driver 7.0 
...
-- in Microsoft JDBC Driver 7.0 for SQL Server distributed transactions.
